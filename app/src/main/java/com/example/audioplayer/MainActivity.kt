    ...
    //very very important
        ...
        scope.launch {
            (player.event.onPlayerActionTriggeredExternally).collectLatest {//this is the inbuilt functions
                when (it) {
        ...
        scope.launch {
            (player.event.stateChange).collectLatest {//this is the inbuilt functions
                when (it) {
        ...
        scope.launch {
            (player.event.audioItemTransition).collectLatest {//this is the inbuilt functions
